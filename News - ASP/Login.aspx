...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
       ...
       <div class="form-style-2-heading"><h1 style="color:blue"><%: Title %>.</h1></div>
    
    
    <section id="loginForm" style="background-color:lightblue">
        <h2>Use a local account to log in.</h2>
        <asp:Login runat="server" ViewStateMode="Disabled" RenderOuterTable="false" ID="myLogin" OnLoginError="myLogin_LoginError">
            <LayoutTemplate>
