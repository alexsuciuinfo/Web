<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AddEditor.aspx.cs" Inherits="ManagerPages_AddEditor" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:CreateUserWizard LoginCreatedUser="false" OnFinishButtonClick="CreateUserWizard1_FinishButtonClick" ID="CreateUserWizard1" runat="server" OnContinueButtonClick="CreateUserWizard1_ContinueButtonClick" OnCreatedUser="CreateUserWizard1_CreatedUser">
    ...
    <ContentTemplate>
     ...
     <asp:Literal runat="server" ID="LRaspuns"  Text="lala"/>
